...
namespace SOPB.DAL.AccessData
{
    public class Tables
    {
        ...
        private void InitTables()
        {
            ...
            birthDay.DateTimeMode = DataSetDateTime.Local;
            ...
            landColumn = new DataColumn("NotaBene")
            {
                ReadOnly = false,
                AllowDBNull = true,
            ...
            this.DispancerDataSet.Tables.Add(LandDataTable);
            ...
            disabilityColumn.ReadOnly = true;
            ...
            invalidColumn.Caption = "Группа инвалидности";
           ...
           {InvalidBenefitsDataTable.Columns[0], InvalidBenefitsDataTable.Columns[1]};
            ...
            LandDataTable.Columns.CollectionChanged += Columns_CollectionChanged;
